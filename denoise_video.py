...
# save the output audio to be denoised
# convert_video_to_audio_ffmpeg(
#     'C:/Users/sarfa/Downloads/FYP/server/tmp/video.mp4')
...
audio, sr = librosa.load(
    r'./tmp/video.wav', res_type='kaiser_fast')
...
sf.write('./tmp/predicted_noise.wav', predicted_noise.astype(
...
if os.path.exists('../client/src/denoised-video/denoised.mp4'):
    os.remove('../client/src/denoised-video/denoised.mp4')
