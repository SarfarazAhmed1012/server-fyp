...
audio_dir_prediction = r'./uploaded_audio'
dir_save_prediction = r'../client/src/denoised_uploaded_audio/'
audio_input_for_pred = ['audio.wav']
audio_output_pred = r'denoisedUploaded.wav'
...
wav_file = pydub.AudioSegment.from_file(
    file="../client/src/denoised_uploaded_audio/denoisedUploaded.wav", format="wav")
...
# Feel the difference!
new_wav_file.export(
    out_f="../client/src/denoised_uploaded_audio/denoisedUploaded.wav", format="wav")

print("making spectrograms")

#  spectrogram generation for noisy input and denoised output
noisy_path = r'../client/src/denoised_uploaded_audio/inputUploadAudio.wav'
denoised_path = r'../client/src/denoised_uploaded_audio/denoisedUploaded.wav'
...
fig.savefig(
    r'../client/src/spectograms_for_uploaded_audio/spec_noisy.png')
...
fig.savefig(
    r'../client/src/spectograms_for_uploaded_audio/spec_denoised.png')
